...
resource "aws_internet_gateway" "main" {
  vpc_id = aws_vpc.main.id    #for vpc association
...
#for NAT gateway first we have to create a elastic ip(EIP)
...
# Associate database route table with the database subnet
